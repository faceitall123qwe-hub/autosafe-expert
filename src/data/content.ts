  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'Help with registration formalities: documents, applications, procedures. Support for foreigners — in English, Polish, Ukrainian and Russian.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Do you help foreigners?', a: 'Yes. I support foreigners with paperwork and vehicle registration — in English, Polish, Ukrainian and Russian.' },
  ...
  ru: {
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'Помощь с формальностями при регистрации: документы, заявления, процедуры. Поддержка иностранцев — на русском, польском, украинском и английском.',
          priceFrom: '100 zł нетто',
          icon: 'doc',
        },
        {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Помогаете ли иностранцам?', a: 'Да. Помогаю иностранцам с формальностями и регистрацией автомобиля — на русском, польском, украинском и английском.' },
  ...
  be: {
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'Дапамога з фармальнасцямі пры рэгістрацыі: дакументы, заявы, працэдуры. Падтрымка замежнікаў — па-беларуску, па-польску, па-руску і па-ўкраінску.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Ці дапамагаеце замежнікам?', a: 'Так. Дапамагаю замежнікам з фармальнасцямі і рэгістрацыяй аўтамабіля — па-беларуску, па-польску, па-руску і па-ўкраінску.' },
